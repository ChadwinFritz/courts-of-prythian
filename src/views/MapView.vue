  ...
  <main>
    ...
    <div class="map-layout">
      <div class="map-wrap">
        ...
        >
          <!-- Background -->
          <rect width="520" height="760" fill="#0d1020" />

          <!-- Sea texture dots -->
          <circle cx="30" cy="400" r="1.5" fill="rgba(255,255,255,.18)" />
          <circle cx="490" cy="430" r="1.5" fill="rgba(255,255,255,.18)" />
          <circle cx="20" cy="200" r="1" fill="rgba(255,255,255,.12)" />
          ...
          <!-- Night Court star icon -->
          <path d="M150,120 l6,-18 6,18 18,6 -18,6 -6,18 -6,-18 -18,-6 Z" fill="#e8c877" />

          <!-- Mountains -->
          <path d="M290,150 l10,22 -20,0 Z M310,150 l10,22 -20,0 Z M330,148 l11,24 -22,0 Z" fill="#3a4180" />

          <!-- Dawn half-circle -->
          <path d="M330,268 a16,16 0 0 1 32,0 Z" fill="#f2d9a8" />

          <!-- Winter snowflake lines -->
          <path
            d="M150,338 l0,28 M136,352 l28,0 M140,342 l20,20 M160,342 l-20,20"
            stroke="#eef5fb"
            stroke-width="2.4"
            fill="none"
          />
          ...
          <!-- Autumn flame -->
          <path
            d="M340,330 c8,10 20,10 20,24 c0,14 -12,20 -20,26 c-8,-6 -20,-12 -20,-26 c0,-14 12,-14 20,-24 Z"
            fill="#e0913f"
          />

          <!-- Summer waves -->
          <path
            d="M130,432 q10,-8 20,0 q10,8 20,0 M130,448 q10,-8 20,0 q10,8 20,0"
            stroke="#bfe0f0"
            stroke-width="2.4"
            fill="none"
          />
          ...
          <!-- Spring flower -->
          <path
            d="M270,516 c8,4 12,12 8,20 c-3,6 -13,7 -16,1 c-2,-4 2,-8 6,-6 c-3,-6 -2,-11 2,-15 Z"
            fill="#d1798e"
          />

          <!-- Mortal cottage -->
          <path d="M240,650 l12,0 0,-14 10,0 0,14 12,0 0,10 -34,0 Z" fill="#5c5340" />

          <!-- Day sun circle -->
          <circle cx="140" cy="258" r="9" fill="#f4e2ad" />

          <!-- Region labels -->
          <text x="210" y="140" fill="rgba(255,255,255,.8)" font-size="9" font-family="serif" text-anchor="middle">Night</text>
          <text x="140" y="260" fill="rgba(30,20,10,.8)" font-size="8" font-family="serif" text-anchor="middle">Day</text>
          <text x="346" y="282" fill="rgba(30,20,10,.8)" font-size="8" font-family="serif" text-anchor="middle">Dawn</text>
          <text x="160" y="370" fill="rgba(30,20,10,.8)" font-size="8" font-family="serif" text-anchor="middle">Winter</text>
          <text x="340" y="370" fill="rgba(255,255,255,.85)" font-size="8" font-family="serif" text-anchor="middle">Autumn</text>
          <text x="160" y="455" fill="rgba(255,255,255,.85)" font-size="8" font-family="serif" text-anchor="middle">Summer</text>
          <text x="270" y="545" fill="rgba(255,255,255,.85)" font-size="8" font-family="serif" text-anchor="middle">Spring</text>
          <text x="278" y="582" fill="rgba(255,255,255,.8)" font-size="7.5" font-family="serif" text-anchor="middle">The Wall</text>
          <text x="270" y="675" fill="rgba(255,255,255,.8)" font-size="8" font-family="serif" text-anchor="middle">Mortal Lands</text>
        </svg>
      </div>
      ...
      <div class="map-info" :class="{ active: selected }">
        ...
        <template v-else>
          ...
          <p class="map-hint">An original, lovingly unofficial chart — geography approximate, magic guaranteed.</p>
        </template>
      </div>
    </div>
  </main>
...
.region:focus {
  opacity: 1;
  filter: drop-shadow(0 0 10px rgba(232, 200, 119, 0.6));
  outline: none;
}

.region.active {
  opacity: 1;
  filter: drop-shadow(0 0 13px rgba(232, 200, 119, 0.95));
}
